...
<style>
  main { max-width: 720px; margin: 0 auto; padding: 24px 16px 64px; display: flex; flex-direction: column; gap: 16px; }
  header h1 { margin: 0 0 16px; font-size: 22px; }
</style>
